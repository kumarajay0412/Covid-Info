...
function Worldcard() {
    ...
    return (
        <div>
            ...
            <Grid item xs={12} sm={3}>
            <Card className={classes.card} elevation={4} expand style={{color: '#fff', background: `url(${background5})` }}>       
                    <CardContent>
                        <div>
                            <Grid  container spacing={1} >
                                <Grid item xs={3}>  <a><img src={vaccine} height="50" width="50" alt='corona' /><b></b></a> </Grid>
